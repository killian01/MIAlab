...
def load_images(image_paths):
    ...
    # print(image_paths)
    image_dict = {
        structure.BrainImageTypes.T1w: sitk.ReadImage(image_paths[structure.BrainImageTypes.T1w],
                                                      sitk.sitkFloat32),  # todo: modify here
        structure.BrainImageTypes.GroundTruth: sitk.ReadImage(image_paths[structure.BrainImageTypes.GroundTruth],
                                                              sitk.sitkUInt8)  # todo: modify here
    }
...
def register_images(image_dict, atlas_img):
    ...
    registered_t1 = registration.execute(image_dict[structure.BrainImageTypes.T1w],
                                         registration_params)  # todo: modify here
    # pdb.set_trace()
    ...
    #  transform=tegistration.transform, interpolator=sitk.sitkNearestNeighbor
...
def preprocess_filter_rescale_t1(image_dict, new_min_val, new_max_val):
    ...
    minmax_rescaled_img = filter.execute(image_dict[structure.BrainImageTypes.T1w],
                                         filter_params)   # todo: modify here
